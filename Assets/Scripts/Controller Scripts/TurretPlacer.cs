...
public class TurretPlacer : Singleton<TurretPlacer>
{
    ...
    public bool TryPlaceTurret()
    {
        ...
        Turret turret = _map.GetTurretWorldSpace(_currentMouseTile);
        if (turret)
        {
        ...
        // create the turret
        Turret newTurret = _turretController.PlaceTurret(_currentMouseTile);
    ...
    public bool TryDeselectTurret()
    {
        ...
        if (_currentTurretPrefab)
        {
            ...
            // deselect the turret
            _uiController.hotbar.DeselectAll();
            SetTurretPrefab(null);
    ...
    private void RecalculateCanPlace()
    {
        ...
        bool isPlaceable = _map.IsTilePlaceableWorldSpace(_currentMouseTile);
        if (isPlaceable)
        {
        ...
        // move the previews
        UpdatePreviewPosition(_currentMouseTile);
